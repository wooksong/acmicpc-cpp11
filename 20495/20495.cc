...
size_t bianry_search_min (std::vector<NumInRange> &v, size_t idx_s, size_t idx_e, int val);

size_t bianry_search_max (std::vector<NumInRange> &v, size_t idx_s, size_t idx_e, int val);
...
size_t
bianry_search_max (std::vector<NumInRange> &v, size_t idx_s, size_t idx_e, int val)
{
  size_t idx_m;
...
size_t
bianry_search_min (std::vector<NumInRange> &v, size_t idx_s, size_t idx_e, int val)
{
  size_t idx_m;
