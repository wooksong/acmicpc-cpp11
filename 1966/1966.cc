...
bool
operator== (Document &lhs, Document &rhs)
{
...
std::ostream &
operator<< (std::ostream &os, const Document &d)
{
...
void
merge (Document *dcmts, int s, int m, int e)
{
  int i, j, pos;
  i = s;
  j = m;
...
void
sort (Document *dcmts, int s, int e)
{
  int m;
