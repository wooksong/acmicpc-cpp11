...
uint64_t binary_search (std::vector<uint64_t> v, uint64_t min, uint64_t max, uint64_t num);
...
uint64_t
binary_search (std::vector<uint64_t> v, uint64_t min, uint64_t max, uint64_t num)
{
